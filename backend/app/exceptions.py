...
class AppError(Exception):
    ...
    def __init__(self, detail: str, error_code: str = "INTERNAL_ERROR", status_code: int = status.HTTP_500_INTERNAL_SERVER_ERROR) -> None:
        self.detail = detail
...
class RateLimitError(AppError):
    ...
    def __init__(self, detail: str = "Rate limit exceeded", error_code: str = "RATE_LIMITED") -> None:
